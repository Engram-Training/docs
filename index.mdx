---
title: "Engram"
description: "Persistent, versioned memory for AI agents — powered by Shelby Protocol on Aptos blockchain"
---

## What is Engram?

AI agents are stateless by default — every conversation starts from scratch. Engram gives agents a **persistent, versioned memory layer** backed by [Shelby Protocol](https://shelby.xyz), a decentralized storage network on the Aptos blockchain.
...
<CardGroup cols={3}>
  ...
  <Card title="Auto-Funded Wallets" icon="wallet">
    Agent wallets are automatically funded with APT and ShelbyUSD. No manual blockchain management needed.
  </Card>
  <Card title="Content Compression" icon="file-zipper">
    Text content over 1 KB is automatically gzip-compressed before storage. Decompression is transparent on read.
  </Card>
</CardGroup>
