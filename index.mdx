...
AI agents are [stateless by default](/why-stateless) — every conversation starts from scratch. Engram gives agents a **persistent, versioned memory layer** backed by [Shelby Protocol](https://shelby.xyz), a decentralized storage network on the Aptos blockchain.
